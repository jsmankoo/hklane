...
$all_listings = getRentalListings($uid, $sid, "RNT", $getactive, $getpendingsold, 0);
//$all_listings = getListings($uid, $sid, "RNT", $getactive, $getpendingsold, 0);
...
try 
{
	$newfile="/home/hklane3/hklane/public/christie_feed/write_rental.xml"; 	
